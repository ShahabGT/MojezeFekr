...
import projects.shahabgt.com.onlinelibrary.MessagesActivity;
import projects.shahabgt.com.onlinelibrary.models.MessagesModel;
...
public class DatabaseOperations extends SQLiteOpenHelper {
    ...
    public boolean insert(Context context,String title,String message,String sender,String date){
        ...
        String person = sp.getString("number", "");
